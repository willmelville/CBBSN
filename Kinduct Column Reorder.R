...
KinductHitter <- Duct[c(2,3,1,24,84,73,25,
                ...
                81,83,39,64)]
KinductPitcher <- Duct[c(2,3,1,24,84,73,25,
...
write.csv(KinductHitter,"KinductHitter.csv")
write.csv(KinductPitcher,"KinductPitcher.csv")
