...
///
	...
	Position_Players$Name <- paste(Position_Players$FIRST_NAME, " ", Position_Players$LAST_NAME, " -- ", Position_Players$PLAYER_SCHOOL)
	...
	Pitchers$Name <- paste(Pitchers$FIRST_NAME, " ", Pitchers$LAST_NAME, " -- ", Pitchers$PLAYER_SCHOOL)
	...
	unique(Pitchers$CONFERENCE)
	unique(Position_Players$CONFERENCE)
	
	# How many scouts have collected data for pos.players/pitchers?
	unique(Pitchers$SCOUT.NAME)
	unique(Position_Players$SCOUT.NAME)
