...
#### Velo discrepancies/difference ####
	# If negative value, locate & check row then contact RM/ARM ***
		...
		hist(Pitchers$FB_Diff, main = "Fastball Velo Difference")
		...
		Pitchers$BREAKING_BALL_Diff <- NA
			...
			hist(Pitchers$BREAKING_BALL_Diff, main = "BB Velo Difference")
		...
		Pitchers$THIRD_PITCH_Diff <- NA
			...
			hist(Pitchers$THIRD_PITCH_Diff, main = "3rd Pitch Velo Difference")
		...
		Pitchers$FOURTH_PITCH_Diff <- NA
			...
			hist(Pitchers$FOURTH_PITCH_Diff, main = "4th Velo Difference")
		...
		# Fastball vs Other
			Pitchers$FB_BREAK_VELO_Diff <- NA
				...
				boxplot(Pitchers$FB_BREAK_VELO_Diff, main = "FB/Breaking Ball Velo Difference")
				# 	require(ggplot2)
			...
			Pitchers$FB_THIRD_VELO_Diff <- NA
				...
				boxplot(Pitchers$FB_THIRD_VELO_Diff, main = "FB/Third Pitch Velo Difference")
		
			Pitchers$FB_FOURTH_VELO_Diff <- NA
				Pitchers$FB_FOURTH_VELO_Diff <- Pitchers$FASTBALL_VELO_MAX - Pitchers$FOURTH_PITCH_VELO_MAX
				boxplot(Pitchers$FB_FOURTH_VELO_Diff, main = "FB/Fourth Velo Difference")
...
# Data check
	##### Pitchers Data Check #####
		...
		describe(Pitchers$WEIGHT)
			...
			hist(Pitchers$WEIGHT, main = "Pitcher Weight")
		...
		describe(Pitchers$STRIKE_BALL_PERCENTAGE, na.rm = TRUE)
			...
			hist(Pitchers$STRIKE_BALL_PERCENTAGE, main = "Pitcher Strike/Ball Percentage")
...
///
		...
		describe(Pitchers$FASTBALL_VELO_MIN)
			...
			hist(Pitchers$FASTBALL_VELO_MIN, main = "Fastball Min Velo")
	
		describe(Pitchers$FASTBALL_VELO_MAX)
			boxplot(Pitchers$FASTBALL_VELO_MAX, main = "Fastball Max Velo")
			hist(Pitchers$FASTBALL_VELO_MAX, main = "Fastball Max Velo")
	...
	///
		...
		describe(Pitchers$BREAKING_BALL_VELO_MIN)
			...
			hist(Pitchers$BREAKING_BALL_VELO_MIN, main = "Breaking Ball Min Velo")
	
		describe(Pitchers$BREAKING_BALL_VELO_MAX)
			boxplot(Pitchers$BREAKING_BALL_VELO_MAX, main = "Breaking Ball Max Velo")
			hist(Pitchers$BREAKING_BALL_VELO_MAX, main = "Breaking Ball Max Velo")
		...
		describe(Pitchers$TOTAL_SWINGS_BREAKING_BALL)
			...
			hist(Pitchers$TOTAL_SWINGS_BREAKING_BALL, main = "Breaking Ball Total Swings")
		...
		describe(Pitchers$SWINGS_AND_MISSES_BREAKING_BALL)
			...
			hist(Pitchers$SWINGS_AND_MISSES_BREAKING_BALL, main = "Breaking Ball Whiffs")
	
		describe(Pitchers$CHASE_SWINGS_BREAKING_BALL)
			boxplot(Pitchers$CHASE_SWINGS_BREAKING_BALL, main = "Breaking Ball Chase Swings")
			hist(Pitchers$CHASE_SWINGS_BREAKING_BALL, main = "Breaking Ball Chase Swings")
		...
		describe(Pitchers$HARD_CONTACT_BREAKING_BALL)
			...
			hist(Pitchers$HARD_CONTACT_BREAKING_BALL, main = "Breaking Ball Hard Contact Against")
	...
	///
		...
		describe(Pitchers$THIRD_PITCH_VELO_MIN)
			...
			hist(Pitchers$THIRD_PITCH_VELO_MIN, main = "3rd Pitch Min Velo")
	
		describe(Pitchers$THIRD_PITCH_VELO_MAX)
			boxplot(Pitchers$THIRD_PITCH_VELO_MAX, main = "3rd Pitch Max Velo")
			hist(Pitchers$THIRD_PITCH_VELO_MAX, main = "3rd Pitch Max Velo")
	...
	##### Position Players Data Check #####
		...
		describe(Position_Players$WEIGHT_LBS)
			...
			hist(Position_Players$WEIGHT_LBS, main = "Position Player Weight")
		...
		describe(Position_Players$HEIGHT_IN)
			...
			hist(Position_Players$HEIGHT_IN, main = "Position Player Height")
		...
		Position_Players$BP_HOME_RUNS_MIDDLE <- as.numeric(Position_Players$BP_HOME_RUNS_MIDDLE)
			...
			hist(Position_Players$BP_HOME_RUNS_MIDDLE, main = "Position Player BP HR Middle")
		...
		Position_Players$BP_HOME_RUNS_OPPOSITE_FIELD <- as.numeric(Position_Players$BP_HOME_RUNS_OPPOSITE_FIELD)
			...
			hist(Position_Players$BP_HOME_RUNS_OPPOSITE_FIELD, main = "Position Player BP HR Oppo")
		...
		Position_Players$BP_HOME_RUNS_PULL <- as.numeric(Position_Players$BP_HOME_RUNS_PULL)
			...
			hist(Position_Players$BP_HOME_RUNS_PULL, main = "Position Player BP HR Pull")
		...
		Position_Players$WALKS <- as.numeric(Position_Players$WALKS)
			...
			hist(Position_Players$WALKS, main = "Position Player Walks")
		...
		Position_Players$HITS <- as.numeric(Position_Players$HITS)
			...
			hist(Position_Players$HITS, main = "Position Player Hits")
		...
		describe(Position_Players$SWING_AND_MISSES)
			...
			hist(Position_Players$SWING_AND_MISSES, main = "Position Player Swings & Misses")
	
		describe(Position_Players$CHASE_SWINGS)
			boxplot(Position_Players$CHASE_SWINGS, main = "Position Player Chase Swings")
			hist(Position_Players$CHASE_SWINGS, main = "Position Player Chase Swings")
	
		describe(Position_Players$SWINGS_FB)
			boxplot(Position_Players$SWINGS_FB, main = "Position Player Swings (Fastballs Only)")
			hist(Position_Players$SWINGS_FB, main = "Position Player Swings (Fastballs Only)")
	
		describe(Position_Players$TOTAL_PITCHES_AGAINST)
			boxplot(Position_Players$TOTAL_PITCHES_AGAINST, main = "Position Player Length of At Bat (Pitches)")
			hist(Position_Players$TOTAL_PITCHES_AGAINST, main = "Position Player Length of At Bat (Pitches)")
		...
		describe(Position_Players$HARD_CONTACT_PULL_SIDE)
			...
			hist(Position_Players$HARD_CONTACT_PULL_SIDE, main = "Position Player Hard Contact (Pull)")
		...
		describe(Position_Players$HARD_CONTACT_OPPOSITE_FIELD)
			...
			hist(Position_Players$HARD_CONTACT_OPPOSITE_FIELD, main = "Position Player Hard Contact (Opposite Field)")
	
		describe(Position_Players)
			boxplot(Position_Players$HARD_CONTACT_MIDDLE, main = "Position Player Hard Contact (Middle)")
			hist(Position_Players$HARD_CONTACT_MIDDLE, main = "Position Player Hard Contact (Middle)")
		...
		Position_Players$ABOVE_AVERAGE_DEFENSIVE_PLAYS <- as.numeric(Position_Players$ABOVE_AVERAGE_DEFENSIVE_PLAYS)
			...
			hist(Position_Players$ABOVE_AVERAGE_DEFENSIVE_PLAYS, main = "Position Player Above Avg. Defensive Plays")
		...
		Position_Players$ERRORS_COMMITTED <- as.numeric(Position_Players$ERRORS_COMMITTED)
			...
			hist(Position_Players$ERRORS_COMMITTED, main = "Position Player Errors Committed")
